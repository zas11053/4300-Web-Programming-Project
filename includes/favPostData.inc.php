...
session_start();
 ...
 if(isset($_POST["limit"], $_POST["start"])){
    ...
    $sql = "SELECT * FROM fav INNER JOIN posts ON posts.postID = fav.postID WHERE fav.usersIDS=$usersIDNum
    ORDER BY fav.favID DESC LIMIT ".$start.",".$limit."";
